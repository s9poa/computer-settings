        ...
        <header className={styles["mobile-header"]}>
            <aside ref={asideRef} className={styles["main-aside"]} style={{ transform: menuOpen ? "translateX(0)" : "translateX(-100%)", transition: "transform 0.3s ease-in-out" }} aria-hidden={!menuOpen} inert={!menuOpen ? true : undefined}>
                ...
                <nav>
                    ...
                    <Link to="/computer-settings/language" onClick={closeMenu} className={location.pathname === "/computer-settings/language" ? styles.active : ""}><i className="fa-solid fa-globe"></i>Time & Language</Link>
                    ...
                    <Link to="/computer-settings/privacy" onClick={closeMenu} className={location.pathname === "/computer-settings/privacy" ? styles.active : ""}><i className="fa-solid fa-shield"></i>Privacy & Security</Link>
